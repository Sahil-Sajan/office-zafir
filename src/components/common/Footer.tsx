...
const footerSections: { titleKey: string; links: { labelKey: string; href: string }[] }[] = [
  ...
  // },
  {
    titleKey: "Rewards & Tools",
    links: [
      // { labelKey: "Wishlist", href: "/wishlist" },
      // { labelKey: "Compare Products", href: "/compare" },
      { labelKey: "Gift Cards", href: "/gift-cards" },
      { labelKey: "Nuqat Rewards", href: "/loyalty" },
      { labelKey: "Wallet", href: "/wallet" },
      { labelKey: "Refer & Earn", href: "/referral" },
      // { labelKey: "What's New", href: "/whats-new" },
      { labelKey: "Become an Affiliate", href: "/become-an-affiliate" },
    ],
  },
  {
