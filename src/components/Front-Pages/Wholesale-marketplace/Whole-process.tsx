const steps = [
    { title: "01 · Browse", desc: "Explore wholesale listings filtered by category, supplier, and MOQ." },
    { title: "02 · Request Quote", desc: "Submit an RFQ to up to five matched suppliers with your required quantity." },
    { title: "03 · Negotiate Price", desc: "Communicate directly with the supplier to agree final terms." },
    { title: "04 · Confirm Order", desc: "Lock in pricing, Incoterm, and payment method — escrow holds the funds." },
    { title: "05 · Fast Delivery", desc: "Coordinated logistics to your warehouse or site, tracked end to end." },
]
                ...
                <div className="flex justify-between items-end gap-6 flex-wrap mb-9">
                    <div>
                        ...
                        <h2 className="text-[clamp(1.6rem,1.35rem+1vw,2.3rem)] font-bold tracking-[-0.02em] leading-[1.1] mt-3 mb-[10px] text-[#0E241C]">
                            Discovery to delivery, <span className="text-[#C9A853] italic">built for business buyers.</span>
                        </h2>
                    </div>
                </div>
