            ...
            <div className="max-w-[1180px] mx-auto px-4 sm:px-7">
                <div className="bg-[#0E241C] rounded-[16px] p-6 sm:p-[52px] flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 sm:gap-8 flex-wrap text-[#FAF6EA]">
                    <div>
                        ...
                        <p className="text-[#C9A853] mt-[10px] max-w-[480px] text-[1rem]">
                            Tell us your origin, cargo type, and volume — we&apos;ll return FCL and LCL options with an all-in landed cost estimate.
                        </p>
                    </div>
                    <Link
