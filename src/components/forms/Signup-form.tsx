...
function GoogleIcon() {
  return (
    <svg className="size-[24px]" viewBox="0 0 24 24">
...
function AppleIcon() {
  return (
    <svg className="size-[24px]" viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    <form className="flex flex-col gap-4 w-full" onSubmit={(e) => e.preventDefault()}>
      <div className="flex flex-col gap-[6px]">
        <label htmlFor="signup-name" className="text-[0.82rem] font-semibold text-[#1C2420]">Full name</label>
        <input
          id="signup-name"
          type="text"
          required
      ...
      <div className="flex flex-col gap-[6px]">
        <label htmlFor="signup-email" className="text-[0.82rem] font-semibold text-[#1C2420]">Email address</label>
        <input
          id="signup-email"
          type="email"
          required
      ...
      <div className="flex flex-col gap-[6px]">
        <label htmlFor="signup-password" className="text-[0.82rem] font-semibold text-[#1C2420]">Password</label>
      ...
      <label className="flex items-start gap-2.5 text-[0.82rem] text-[#1C2420] leading-[1.5]">
        <input type="checkbox" required className="mt-[3px] accent-[#17362A]" />
        <span>
          I agree to the{" "}
          <Link href={`/${lang}/terms-conditions`} className="text-[#234A3A] no-underline hover:underline">Terms &amp; Conditions</Link>
          {" "}and{" "}
          <Link href={`/${lang}/privacy-policy`} className="text-[#234A3A] no-underline hover:underline">Privacy Policy</Link>.
        </span>
      </label>
      ...
      <div className="flex items-center gap-3 my-1">
        ...
        <span className="text-[0.78rem] text-[#5B6961]">or sign up with</span>
        <span className="flex-1 h-px bg-[#F0EADB]" />
      </div>
